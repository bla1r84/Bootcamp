	...
	<div class="container text-left">
		<table>
			<tr>
				...
				<td style="padding-bottom: 5px"><a href="control-panel_menu.jsp"
					class="btn btn-primary" role="button"><i
						class="glyphicon glyphicon-arrow-left"></i>&nbsp;Go back</a></td>
				<br>
			</tr>
			<tr>
				<td style="padding-right: 5px"><a href="#"
					class="btn btn-success" role="button"><i
						class="fa fa-graduation-cap"></i>&nbsp;Assign/Unassign an admin</a></td>
				<td style="padding-right: 5px"><a href="#"
					class="btn btn-warning" role="button"><i
						class="glyphicon glyphicon-ban-circle"></i>&nbsp;Ban user</a></td>
				<td><a href="#" class="btn btn-danger" role="button"><i
						class="fa fa-remove"></i>&nbsp;Delete user</a></td>
			</tr>
		</table>
	</div>
	<br>
